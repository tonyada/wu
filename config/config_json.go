...
func InitJSON(filepath string, isOverwrite bool, config interface{}) error {
	return NewJSON(filepath, true, config)
}

// create a config.json file
// config.NewJSON("config.json", false, settings)
func NewJSON(filepath string, isOverwrite bool, config interface{}) error {
...
func LoadJSON(filepath string, config interface{}) error {
